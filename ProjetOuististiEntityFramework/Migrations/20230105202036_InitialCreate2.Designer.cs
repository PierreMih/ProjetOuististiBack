...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjetOuististiDomain.Calculs.CalculAbstract", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("ProjetOuististiDomain.Calculs.CalculAddition", b =>
                {
                    b.HasBaseType("ProjetOuististiDomain.Calculs.CalculAbstract");

                    b.HasDiscriminator().HasValue("CalculAddition");
                });

            modelBuilder.Entity("ProjetOuististiDomain.Calculs.CalculDivision", b =>
                {
                    b.HasBaseType("ProjetOuististiDomain.Calculs.CalculAbstract");
            ...
            modelBuilder.Entity("ProjetOuististiDomain.Calculs.CalculMultiplication", b =>
                {
                    b.HasBaseType("ProjetOuististiDomain.Calculs.CalculAbstract");
            ...
            modelBuilder.Entity("ProjetOuististiDomain.Calculs.CalculSoustraction", b =>
                {
                    b.HasBaseType("ProjetOuististiDomain.Calculs.CalculAbstract");
